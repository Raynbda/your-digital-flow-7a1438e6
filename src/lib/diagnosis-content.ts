...
export const offer = {
  eyebrow: "The Creative Workflow Transformation",
  title: "Content Creator OS",
  badge: "Done-with-you",
  subtitle: "Your digital environment, rebuilt around the way you actually create.",
  price: "$500",
  priceNote: "14-day transformation · 1 client every 2 weeks",
  ctaLabel: "Apply for a Transformation",
  includes: [
    "Workflow analysis",
    "Friction diagnosis",
